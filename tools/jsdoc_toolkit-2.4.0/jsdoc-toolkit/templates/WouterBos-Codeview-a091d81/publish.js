...
function publish(symbolSet) {
    ...
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"cocos2d-html5.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    ...
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"button-closed.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"button-open.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"button.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"list-item-open.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"list-item-root.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"list-item-contents.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"list-item-last-open.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"list-item-last-closed.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"list-item-last.png", publish.conf.outDir+"/"+publish.conf.cssDir);
    IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"list-item.png", publish.conf.outDir+"/"+publish.conf.cssDir);
}
